...
public class DatabaseInitializer implements ServletContextInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException { //hier wird die Datenbank gefüllt
        ...
        ServiceUser root = new ServiceUser("Pasquier", "Jacques", "0", "japas102@hhu.de", "$2a$08$MbCSKfkg1C9A6mx82wwVneBpUkyW1ZwhsEjorhqkMYrhRxLJDZ9yO", "ROLE_ADMIN");
        ServiceUser joe = new ServiceUser("Test", "Test", "1", "test102@hhu.de", "$2a$08$MbCSKfkg1C9A6mx82wwVneBpUkyW1ZwhsEjorhqkMYrhRxLJDZ9yO", "ROLE_ADMIN");
