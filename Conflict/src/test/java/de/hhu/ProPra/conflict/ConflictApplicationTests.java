...
public class ConflictApplicationTests {
	...
	public void setUp() {
		...
		mc.setUserRepository(userRepo);
		mc.setLendingRepository(lendingRepo);
		mc.setMailService(mailService);
	...
	public void openConflictTest(){
		assertEquals("redirect:/openConflict", mc.openConflictpost(m, "open", 7, ""));
		assertEquals("redirect:/", mc.openConflictpost(m, "notOpen", 7, ""));
	}
